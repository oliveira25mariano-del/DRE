...
export const payroll = pgTable("payroll", {
  ...
  salarios: varchar("salarios").notNull().default("0"),
  horaExtra: varchar("hora_extra").notNull().default("0"),
  beneficios: varchar("beneficios").notNull().default("0"),
  vt: varchar("vt").notNull().default("0"),
  imestra: varchar("imestra").notNull().default("0"),
  createdAt: timestamp("created_at").default(sql`now()`),
  updatedAt: timestamp("updated_at").default(sql`now()`),
});
